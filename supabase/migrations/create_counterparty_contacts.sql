-- Миграция: Создание таблицы контактных лиц контрагентов
-- Дата: 2025-11-22
-- Описание: Добавление таблицы для хранения контактных лиц контрагентов
--            (у одного контрагента может быть несколько контактных лиц)

-- Создаем таблицу контактных лиц контрагентов
